...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    .icon-box img {
  max-width: 100%; /* Mengatur lebar maksimum gambar menjadi 100% dari kotak */
  height: auto; /* Mengatur ketinggian gambar agar proporsi tetap terjaga */
}
  .card-body img {
  max-width: 100%; /* Mengatur lebar maksimum gambar menjadi 100% dari kotak */
  height: auto; /* Mengatur ketinggian gambar agar proporsi tetap terjaga */
...
.card:hover {
  ...
  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1); /* Menambah bayangan saat melayang */
}
...
@media (max-width: 767px) {
  .card {
    margin-bottom: 0; /* Menghapus margin-bottom pada tampilan mobile */
  }
}
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Stunting Tracker</a></h1>
...
<section id="hero" class="d-flex align-items-center" style="padding-top: 0px;">
  <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
    <div class="row justify-content-center">
      <div class="col-xl-7 col-lg-9 text-center" style="margin-top: 285px;">
        <h1 class="my-4" style="margin-top: 100px;">Mulai peduli terhadap kesehatan bayi anda</h1>
        <h2>Stunting Tracker Hadir membantu memonitoring kesehatan anda</h2>
    ...
    <div class="container">
  <div class="row justify-content-center">
    <div class="col-md-4 col-xs-12"> <!-- Menambahkan col-xs-12 -->
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Edukasi Kesehatan.</h5>
          <img src="{{url('/storage/bg1.jpg')}}" alt="">
          <p class="card-text">.</p>
        </div>
      </div>
    </div>
    <div class="col-md-4 col-xs-12"> <!-- Menambahkan col-xs-12 -->
      <div class="card text-center">
        <div class="card-body">
        <a href ="/timbangan_bmi/">
          <h5 class="card-title">Timbangan BMI</h5>
           </a>
          <img src="{{url('/storage/bg2.jpg')}}" alt="">
        </div>
      </div>
    </div>
    <div class="col-md-4 col-xs-12"> <!-- Menambahkan col-xs-12 -->
      <div class="card text-center">
        <div class="card-body">
          ...
          <img src="{{url('/storage/bg3.jpg')}}" alt="">
        </div>
      </div>                                                                                           
    </div>
  </div>
  ...
  @foreach($posts as $post)
    <div class="col-lg-4 col-md-6 mt-4" data-aos="zoom-in" data-aos-delay="300">
      <div class="icon-box iconbox-pink">
        ...
        <a href="/posts/{{ $post->slug }}" class="btn btn-primary mt-4">Selengkapnya..</a>
      </div>
    </div>
  @endforeach
</div>
